...
//import com.qima.college.service.MD5Util;
...
public class AuthController {
	...
	public String doRegister(AuthUser authUser, String identiryCode, HttpServletRequest request) {
		...
		if(tmpUser != null){
			...
			authUser.setPassword(EncryptUtil.encodePassword(authUser.getPassword()));
	...
	public String ajaxLogin(AuthUser user, String identiryCode, Integer rememberMe, HttpServletRequest request){
		...
		//UsernamePasswordToken token = new UsernamePasswordToken(user.getUsername(),MD5Util.generate(user.getPassword()));
		UsernamePasswordToken token = new UsernamePasswordToken(user.getUsername(),EncryptUtil.encodePassword(user.getPassword()));
		try {
